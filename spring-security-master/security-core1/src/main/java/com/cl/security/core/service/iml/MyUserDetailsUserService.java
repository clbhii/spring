package com.cl.security.core.service.iml;

import com.cl.security.core.config.CurrentSysUser;
...
public class MyUserDetailsUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new CurrentSysUser("saas", "user",  PasswordEncoderFactories.createDelegatingPasswordEncoder().encode("123456"), AuthorityUtils.commaSeparatedStringToAuthorityList("admin"));
    }
}